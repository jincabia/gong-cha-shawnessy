...
const AddToCartModal = ({ onClose, loading, setLoading }) => {
        ...
        <div className="flex flex-col items-center justify-center space-y-4">
          {loading ? (
            <>
              ...
              <span className="text-slate-500 font-semibold">Adding to cart...</span>
            </>
          ) : (
            <>
              ...
              <span className="text-black font-semibold">Drink added to cart</span>
